	...
	$P.D3TreeRing = $P.defineClass(
			...
			return this;},
		{
			...
			init: function () {
				...
				// utility function -----------------------------------------------------------------------
				// source: http://stackoverflow.com/questions/21284829/having-trouble-selecting-xml-nodes-for-d3-bar-chart
				// RESTful: http://www.reactome.org/pages/documentation/developer-guide/restful-service/#Resources
					...
					d3.text('./data/ratelimitsymbol.txt', function (error, rateLimitSymbols) {
						...
						{   //main
							...
							$P.getXML('./data/homo.xml', function(data){
								...
								var nodesJSON = xmlToJSON(data.childNodes[0]);
								nodeData = partition.nodes(nodesJSON);
